...
class MainWindowView(QtWidgets.QMainWindow):
    ...
    def create_actions(self):
        ...
        self.export_results_as_action = QtGui.QAction("Export Results As...", self)
        self.export_results_as_action.setStatusTip("Export Resultsto a specified file.")
        self.export_results_as_action.triggered.connect(lambda: self.presenter.export_results())
        self.export_results_as_action.setEnabled(False)
        self.disabled_elements.append(self.export_results_as_action)
    ...
    def create_menus(self):
        ...
        self.file_menu.addSeparator()
        self.file_menu.addAction(self.export_results_as_action)
        self.file_menu.addSeparator()
